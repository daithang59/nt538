...
Các chương trình được hiện thực bằng Python theo giao diện chung \func{MAIN(input\_file\_path)}. Mỗi hàm đọc dữ liệu từ tệp đầu vào, xử lý theo yêu cầu của từng challenge và trả về kết quả đúng định dạng để hệ thống chấm có thể kiểm tra tự động.
...
5 & \codepath{challenge/challenge5.py} & File hiện tại chưa có nội dung; phần báo cáo tương ứng được viết theo thiết kế đề xuất từ yêu cầu bài toán. \\
