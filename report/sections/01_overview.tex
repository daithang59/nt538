...
\begin{itemize}
  ...
  \item \textbf{Thiết kế thuật toán}: trình bày luồng xử lý bằng mô tả, pseudocode và lưu đồ minh họa; đồng thời giải thích vai trò của từng bước và cách các tiến trình phối hợp.
  ...
  \item \textbf{Ví dụ minh họa}: đưa ví dụ nhỏ để làm rõ cách thuật toán xử lý dữ liệu và tạo kết quả.
\end{itemize}
...
5 & \codepath{challenge/challenge5.py} & Tìm khóa trực tiếp trên buffer byte; chia vùng dữ liệu thành các khoảng byte, worker trả về offset ứng viên và tiến trình chính quy đổi offset nhỏ nhất về chỉ số mảng. \\
